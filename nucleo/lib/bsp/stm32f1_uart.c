...
//ecriture impolie forc?bloquante sur l'UART1 (?tiliser en IT, en cas d'extr? recours)
...
/*
 * @brief	Cette fonction est appelée par la fonction d'initialisation HAL_Init().
